...
// // ==================================================================================
// // TEAM GRID MEMBER COMPONENT
// // ==================================================================================

// type Socials = { github: string; linkedin: string; instagram: string };
// type TeamMember = { icon: React.ReactNode; label: string; role: string; socials: Socials };

// const TeamGridMember = ({ member, index }: { member: TeamMember; index: number }) => {
...
//         className={`relative z-20 w-12 h-12 rounded-full border-2 border-white/10 bg-[#0f0f10] flex items-center justify-center cursor-pointer shadow-lg group hover:border-[#00ddeb]/50 transition-colors`}
//       >
//         <div className="text-white/80 group-hover:text-[#00ddeb] transition-colors">
//           {member.icon}
//         </div>
//       </motion.div>
...
//         {isHovered && (
//           <motion.div
//             initial={{ opacity: 0, y: isTopRow ? 10 : -10, scale: 0.9, x: "-50%" }}
//             animate={{ opacity: 1, y: isTopRow ? -55 : 55, scale: 1, x: "-50%" }} 
//             exit={{ opacity: 0, y: isTopRow ? 10 : -10, scale: 0.9, x: "-50%" }}
//             transition={{ duration: 0.2, ease: "easeOut" }}
//             className={`absolute left-1/2 w-max flex flex-col items-center gap-2 rounded-xl border border-white/10 bg-[#0a0a0a]/95 backdrop-blur-xl p-3 shadow-2xl z-50 pointer-events-auto
//               ${isTopRow ? 'bottom-0 mb-2' : 'top-0 mt-2'} 
//             `}
//           >
//             {/* Label Section */}
...
//                <a href={member.socials.github} className="text-slate-400 hover:text-white transition-colors hover:scale-110 transform"><Github className="w-3.5 h-3.5" /></a>
//                <a href={member.socials.linkedin} className="text-slate-400 hover:text-[#00ddeb] transition-colors hover:scale-110 transform"><Linkedin className="w-3.5 h-3.5" /></a>
//                <a href={member.socials.instagram} className="text-slate-400 hover:text-pink-500 transition-colors hover:scale-110 transform"><Instagram className="w-3.5 h-3.5" /></a>
//             </div>
            
//             {/* Arrow (Pointing to avatar) */}
//             <div className={`absolute left-1/2 -translate-x-1/2 w-2.5 h-2.5 bg-[#0a0a0a]/95 border-r border-b border-white/10 rotate-45 
//               ${isTopRow ? '-bottom-1.5' : '-top-1.5 border-r-0 border-b-0 border-l border-t'}
//             `}></div>
//           </motion.div>
//         )}
//       </AnimatePresence>
...
//               <button 
//                 onClick={onClose}
//                 className="absolute right-4 top-1/2 -translate-y-1/2 p-2 rounded-full hover:bg-white/10 text-slate-400 hover:text-white transition-colors"
//               >
//                 <X className="w-5 h-5" />
//               </button>
//             </div>
...
//   return (
//     <>
//       {/* ROOT: Pure Black, reduced bottom padding */}
//       <footer className="relative w-full border-t border-white/10 bg-black pt-16 pb-4 z-50">
...
//               {/* FEATURE CARDS GRID */}
//               <div className="flex flex-col sm:flex-row gap-5 w-full max-w-md items-stretch">
                
//                 {/* CARD 1: SOCIALS (UPDATED LAYOUT: Text Top, Icons Bottom Corners) */}
...
//                   {/* 2. ICONS SECTION (Bottom Corners with Margin) */}
//                   <div className="flex justify-between items-end w-full mt-auto px-4 pb-2">
//                     {/* Instagram (Bottom Left) */}
//                     <div className="p-3 rounded-full bg-pink-500/10 text-pink-400 border border-pink-500/20 hover:scale-110 transition-transform duration-300">
//                       <Instagram className="w-6 h-6" />
//                     </div>
                    
//                     {/* Mail (Bottom Right) */}
//                     <div className="p-3 rounded-full bg-[#af40ff]/10 text-[#af40ff] border border-[#af40ff]/20 hover:scale-110 transition-transform duration-300">
...
//                 {/* CARD 2: TEAM (Grid) */}
//                 <div className="w-full sm:w-1/2 flex flex-col justify-between h-40 py-2">
//                   <div className="flex-1 grid grid-cols-2 gap-3 place-items-center">
//                     {teamItems.map((member, index) => (
//                       <TeamGridMember key={index} member={member} index={index} />
//                     ))}
//                   </div>
    ...
    <>
      ...
      <footer className="relative w-full border-t border-white/10 bg-black pt-16 pb-4 z-50">
        ...
        <div className="container relative mx-auto px-6 md:px-12 z-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 mb-16 items-start">
            ...
            <div className="lg:col-span-5 flex flex-col items-start space-y-8">
              ...
              <Link to="/home" onClick={scrollToTop} className="flex items-center gap-3 group">
                ...
                <span className="text-xl font-bold tracking-wide text-white">
                  ACADVERSE<span className="text-[#00ddeb]">.</span>
                </span>
              </Link>
          ...
          {/* Bottom Bar - REFINED SPACING AND ALIGNMENT */}
          <div className="pt-8 border-t border-white/10 flex flex-col lg:flex-row justify-between items-center gap-6 text-xs">
            {/* Left Side Group */}
            <div className="flex flex-col md:flex-row items-center gap-3 md:gap-6 text-center md:text-left text-slate-400">
              <p className="whitespace-nowrap">
                © 2026 Acadverse. Made with <span className="text-red-500 animate-pulse">♥</span> for Engineers.
              </p>
              ...
              <p className="text-slate-500">
                This is an unofficial student initiative created solely to help juniors with academic preparation.
              </p>
            </div>
